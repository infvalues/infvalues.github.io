questions =  [
    ...
    {"id": 44, "question": "Democracy is the better system of government.", "effects": {"noo": -1}},
    ...
    {"id": 49, "question": "Strong leaderships maximize the efficiency of a nation.", "effects": {"const": 1}},
    ...
    {"id": 64, "question": "Everybody should be able to do whatever they want to do.", "effects": {"prud": -1}},
    ...
    {"id": 135, "question": "We should only judge an action based on its consequences.", "effects": {"consq": 1}},
    ...
    {"id": 138, "question": "Work can be an enjoyable experience, as long as people find the right job for them.", "effects": {"enth": 1}},
    ...
    {"id": 163, "question": "The workplace should be hierarchical.", "effects": {"hier": 1}},
